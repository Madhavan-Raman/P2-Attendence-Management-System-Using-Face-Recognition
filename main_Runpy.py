    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Admin/Downloads/Attendance Management System using Face Recognition/Attendance/Manually Attendance/'+ DB_table_name +'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/Admin/Downloads/Attendance Management System using Face Recognition/Attendance/Manually Attendance/-----check attendence-----"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = "C:/Users/Admin/Downloads/Attendance Management System using Face Recognition" + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/Admin/Downloads/Attendance Management System using Face Recognition/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = "C:/Users/Admin/Downloads/Attendance Management System using Face Recognition/StudentDetails/StudentDetails.csv"
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
